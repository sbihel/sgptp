...
class Machine {
  public:
	...
	int32_t ReadIntRegister(
		int num);  //!< Read the contents of an Integer CPU register

	void WriteIntRegister(int num, int32_t value);
	//!< Store a value into an Integer CPU register

	int32_t ReadFPRegister(
		int num);  //!< Read the contents of a floating point register
