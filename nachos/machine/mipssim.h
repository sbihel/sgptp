 ...
 */
static OpInfo opTable[] = {{SPECIAL, RFMT},
                           {BCOND, IFMT},
                           {OP_J, JFMT},
                           {OP_JAL, JFMT},
                           {OP_BEQ, IFMT},
...
static int cop1STable[] = {
    OP_ADD_S,     OP_SUB_S,   OP_MUL_S,     OP_DIV_S,     OP_SQRT_S,
    OP_ABS_S,     OP_MOV_S,   OP_NEG_S,     OP_RES,       OP_RES,
    OP_RES,       OP_RES,     OP_ROUND_W_S, OP_TRUNC_W_S, OP_CEIL_W_S,
    OP_FLOOR_W_S, OP_RES,     OP_UNIMP,     OP_UNIMP,     OP_UNIMP,
    OP_RES,       OP_RES,     OP_RES,       OP_RES,       OP_RES,
    OP_RES,       OP_RES,     OP_RES,       OP_RES,       OP_RES,
    OP_RES,       OP_RES,     OP_RES,       OP_CVT_D_S,   OP_RES,
    OP_RES,       OP_CVT_W_S, OP_RES,       OP_RES,       OP_RES,
    OP_RES,       OP_RES,     OP_RES,       OP_RES,       OP_RES,
    OP_RES,       OP_RES,     OP_RES,       OP_C_F_S,     OP_C_UN_S,
    OP_C_EQ_S,    OP_C_UEQ_S, OP_C_OLT_S,   OP_C_ULT_S,   OP_C_OLE_S,
    OP_C_ULE_S,   OP_C_SF_S,  OP_C_NGLE_S,  OP_C_SEQ_S,   OP_C_NGL_S,
...
static int cop1DTable[] = {
    OP_ADD_D,     OP_SUB_D,   OP_MUL_D,     OP_DIV_D,     OP_SQRT_D,
    OP_ABS_D,     OP_MOV_D,   OP_NEG_D,     OP_RES,       OP_RES,
    OP_RES,       OP_RES,     OP_ROUND_W_D, OP_TRUNC_W_D, OP_CEIL_W_D,
    OP_FLOOR_W_D, OP_RES,     OP_UNIMP,     OP_UNIMP,     OP_UNIMP,
    OP_RES,       OP_RES,     OP_RES,       OP_RES,       OP_RES,
    OP_RES,       OP_RES,     OP_RES,       OP_RES,       OP_RES,
    OP_RES,       OP_RES,     OP_CVT_S_D,   OP_RES,       OP_RES,
    OP_RES,       OP_CVT_W_D, OP_RES,       OP_RES,       OP_RES,
    OP_RES,       OP_RES,     OP_RES,       OP_RES,       OP_RES,
    OP_RES,       OP_RES,     OP_RES,       OP_C_F_D,     OP_C_UN_D,
    OP_C_EQ_D,    OP_C_UEQ_D, OP_C_OLT_D,   OP_C_ULT_D,   OP_C_OLE_D,
    OP_C_ULE_D,   OP_C_SF_D,  OP_C_NGLE_D,  OP_C_SEQ_D,   OP_C_NGL_D,
